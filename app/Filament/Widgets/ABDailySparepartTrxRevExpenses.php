    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(function (Builder $query) {
                ...
                $res =  DailySparepartTrxRevenueExpenses::query()
                    // ->select([
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('revenue_sell_sparepart')
                    ->label('Pendapatan Jual Sparepart')
                    ->numeric()
                    ->money('idr')
                    ->toggleable(isToggledHiddenByDefault: true)
                    ->summarize(Sum::make()),
                Tables\Columns\TextColumn::make('revenue_other')
                    ->label('Pendapatan Jual lainnya')
                    ->numeric()
                    ->money('idr')
                    ->toggleable(isToggledHiddenByDefault: true)
                    ->summarize(Sum::make()),
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    ...
                    ExportBulkAction::make()->exports([
                        ExcelExport::make()
                            ->withFilename('Summary sparepart shipmen transsaction')
                            // ->askForFilename()
                            ...
                            ->withColumns([
                                ...
                                Column::make('revenue_sell_sparepart'),
                                Column::make('revenue_other'),
